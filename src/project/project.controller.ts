...
export class ProjectController {
  ...
  @Get()
  getProjects(@Request() req: TrackingRequest, @Body() dto: CreateProjectDto): Promise<Project[]> {
  ...
  @UseGuards(RolesGuard)
  @Get('all')
  getAllProjects(@Request() req: TrackingRequest, @Body() dto: CreateProjectDto): Promise<Project[]> {
